...
import { registerController, loginController, updatepasswordController, requestPasswordResetController, resetPasswordController, resetPasswordForm } from './auth.controller';
...
authRouter.get('reset-password', resetPasswordForm);
